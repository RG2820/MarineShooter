...
var STACK_BASE = 16130976, STACK_MAX = 21373856, DYNAMIC_BASE = 21373856, DYNAMICTOP_PTR = 16130944;
...
var wasmBinaryFile = "MarineShoter.wasm";
...
var ___tm_current = 16130800;

var ___tm_timezone = (stringToUTF8("GMT", 16130848, 4), 16130848);
...
function nullFunc_vifiif(x) {
 err("Invalid function pointer called with signature 'vifiif'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)");
 err("Build with ASSERTIONS=2 for more info.");
 abort(x);
}
...
var asmLibraryArg = {
 ...
 "nullFunc_vifiif": nullFunc_vifiif,
...
var dynCall_vifiif = Module["dynCall_vifiif"] = function() {
 assert(runtimeInitialized, "you need to wait for the runtime to be ready (e.g. wait for main() to be called)");
 assert(!runtimeExited, "the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)");
 return Module["asm"]["dynCall_vifiif"].apply(null, arguments);
};
